...
export const EXTRAOPTIONBYORG: ExtraOption[][] = [
  [
    {
      ...
      score_list: [
        { option: '국가유공자 자녀', score: 4 },
        { option: '독립유공자 자녀', score: 4 },
      ],
    },
    {
      specialty_id: -1,
    ...
    },
    {
      ...
      score_list: [
        { option: '6개월 ~ 1년 미만', score: 1 },
        { option: '1년 ~ 2년 미만', score: 2 },
        { option: '2년 이상', score: 3 },
      ],
    },
    {
      specialty_id: -1,
      ...
      score_list: [
        { option: '1년 ~ 2년 미만', score: 1 },
        { option: '2년 ~ 4년 미만', score: 2 },
        { option: '4년 이상', score: 3 },
      ],
    },
    {
      specialty_id: -1,
      description: '병역 진로 설계 온라인 서비스 추천 특기 지원자',
      score_list: [{ option: '해당', score: 1 }],
    },
    {
      specialty_id: -1,
      description: '국외이주자 둥 현역병 복무 지원자',
      score_list: [{ option: '해당', score: 4 }],
    },
    {
      specialty_id: -1,
      description:
  ...
  [
    ...
    },
    {
      ...
      description: '잠수기능사',
      score_list: [
        { option: '잠수기능사', score: 5 },
        { option: '잠수기능사보', score: 5 },
      ],
    },
    {
      specialty_id: -2,
    ...
    },
    {
      ...
      score_list: [{ option: '해당', score: 2.5 }],
    },
    {
      specialty_id: -2,
  ...
  [
    ...
    },
    {
      ...
      score_list: [
        { option: '항공정비기초인력인증서 소지자', score: 4 },
        { option: '항공정비사 소지자', score: 4 },
      ],
    },
    {
      specialty_id: [257],
  ...
  [
    ...
    },
    {
      ...
      description: '무도 유단자',
      score_list: [
        { option: '1 ~ 2 단', score: 2 },
        { option: '3단 이상', score: 5 },
      ],
    },
    {
      specialty_id: -4,
    ...
    },
    {
      ...
      score_list: [{ option: '해당', score: 2 }],
    },
    {
      specialty_id: [282, 285, 277, 279, 283, 284, 281],
      description: '공인회계사 자격 소지자',
      score_list: [{ option: '해당', score: 10 }],
    },
    {
      specialty_id: [280],
